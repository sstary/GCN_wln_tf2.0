...
if __name__ == "__main__":
    ...
    parser = OptionParser()
    parser.add_option("-t", "--pred", dest="pred_path",default="test_no_product.txt") # file containing predicted edits
    parser.add_option("-g", "--gold", dest="gold_path",default="test_with_product.txt") # file containing true edits
    parser.add_option("-s", "--singleonly", dest="singleonly", default=True) # only compare single products
    parser.add_option("--bonds_as_doubles", dest="bonds_as_doubles", default=True) # bond types are doubles, not indices
    opts,args = parser.parse_args()

    print(opts.pred_path)
    print(opts.gold_path)
